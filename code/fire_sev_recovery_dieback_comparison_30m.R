...
# setwd('C:\\Users\\Carl\\mystuff\\fireDieoff\\final_figures\\30 test')
...
# list.files(fire_in)
# list.files(fire_in)
raw.sev.control.data <- read.csv(file.path(dir_in, "control_south_sierra_sev_2km_buffer_600pt_5_fire_year_20tree_ts4_30m_20231204.csv"), header = TRUE, na.strings = "NaN")

#Duplicate and add the fire severity columns
un.control.data <- raw.sev.control.data #read.csv(file.path(dir_in, "control_south_sierra_un_sev_2km_buffer_600pt_5_fire_year_20tree_ts4_30m_20231206.csv"), header = TRUE, na.strings = "NaN")
un.control.data$fire_sev_2010 <- 1
low.control.data <- raw.sev.control.data #read.csv(file.path(dir_in, "control_south_sierra_low_sev_2km_buffer_600pt_5_fire_year_20tree_ts4_30m_20231206.csv"), header = TRUE, na.strings = "NaN")
low.control.data$fire_sev_2010 <- 2
med.control.data <- raw.sev.control.data #read.csv(file.path(dir_in, "control_south_sierra_med_sev_2km_buffer_600pt_5_fire_year_20tree_ts4_30m_20231206.csv"), header = TRUE, na.strings = "NaN")
